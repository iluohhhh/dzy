...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <h3 class="title"><b>用户登录</b></h3>
            <form class="form-horizontal" role="form" action="${base}/login/doLogin.shtml" method="post">
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        ...
                        <a href="${base}/login/register.shtml" class="zcnext am-fr am-btn-default"><button type="submit" class="btn btn-default">
                            注册
                        </button></a><br/>
                    </div>
                </div>
